					...
					>
						<div class=" self-center flex items-center justify-center size-9">
							<img
								...
								class="sidebar-new-chat-icon size-6 rounded-full group-hover:hidden dark:brightness-0 dark:invert"
								alt=""
							/>
			...
			>
				...
				>
					<img
						...
						src="{WEBUI_BASE_URL}/static/favicon.png"
						class="sidebar-new-chat-icon size-6 rounded-full dark:brightness-0 dark:invert"
						alt=""
					/>
				</a>
